...
MntServerInfo ControlProxy::getServerInfo()
{
  MntServerInfo ret;
...
void ControlProxy::updateMntControlProcessId(DWORD processId)
{
  AutoLock l(m_gate);

  ControlMessage* msg = createMessage(ControlProto::UPDATE_MNTCONTROL_PROCESS_ID_MSG_ID);
