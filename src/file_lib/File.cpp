...
bool File::setLastModified(INT64 time)
{
  ...
  HANDLE hfile = CreateFile(m_pathName.getString(), GENERIC_READ | GENERIC_WRITE, 0, NULL,
...
{
  HANDLE hfile = CreateFile(m_pathName.getString(), desiredAccess, FILE_SHARE_READ, NULL,
