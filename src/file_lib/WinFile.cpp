...
WinFile::WinFile(const TCHAR* pathToFile, DesiredAccess dAcc, FileMode fMode, bool shareToRead)
  : m_hFile(INVALID_HANDLE_VALUE)
{
...
void WinFile::open(const TCHAR* pathToFile, DesiredAccess dAcc, FileMode fMode, bool shareToRead)
{
